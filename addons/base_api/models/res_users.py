...
class ResUsers(models.Model):
    ...
    password_is_temporary = fields.Boolean(
        string="Password Is Temporary",
        default=False,
        copy=False,
        help="True when the current password was generated by the API (user create or "
             "admin reset). Cleared when the user changes their own password. The SPA "
             "reads this on /auth/me to gate the forced-password-change modal."
    )
